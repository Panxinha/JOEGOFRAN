...
import math
import time
bossPNG = pygame.image.load('VJ-2-Honors/assets/madara.png')
bossPNG_scaled = pygame.transform.scale(bossPNG, (150, 150))
from elements.Jefe1_projectile import jefe1_projectile
...
class Boss1(pygame.sprite.Sprite):
    ...
    def disparo(self, player_pos):
        ...
        projectile=jefe1_projectile(self.rect.center,direction,self.screen_width,self.screen_height)
